...
public class Quest_HelpGant extends BasicQuest {

	public Quest_HelpGant(QuestManager questManager) {
		super(questManager);
	}
	...
	public void onApplied(Entity e, int[] choiceTree) {
		...
		DrunkDuckDispatch.ddd.enterState(3, new FadeOutTransition(), new FadeInTransition());
		finished();
	}
